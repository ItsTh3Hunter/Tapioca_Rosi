...
const menuSalgado = [
    {
        name: "Frango &#127831 ",
        description: "Frango desfiado, mussarela, tomate, cebola, catupiry e orégano."
    },
    {
        name: "Calabresa &#129363 ",
        description: "Calabresa fatiada, mussarela, cebola, tomate, catupiry e orégano."
    },
    {
...
const menuBebidas =[
    ...
    },
    {
        ...
        description: "Coca-cola e Cotuba.",
        price: 7.0
    },
    {
        name: "Refrierante 200ml",
        description: "Coca-cola normal/zero e Cotuba.",
        price: 3.0
    },
    {
        ...
        description: "Uma ótima alternativa ao refrigerante!.",
        price: 4.0
    },
        {
        name: "Coca-cola Lata",
...
function loadMenu() {
    ...
    //Carregar o Menu Bebidas
        ...
        card.innerHTML = `
            ...
            <div class="price" id="centro">R$ ${item.price.toFixed(2).replace('.', ',')}</div>
        `;
